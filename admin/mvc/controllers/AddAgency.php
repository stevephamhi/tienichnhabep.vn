            ...
            <div class="container_fluid d_flex justify_content_between align_items_center">
                <div class="d_flex align_items_end">
                    ...
                    <ol class="breadcrumb d_flex align_items_center">
                        ...
                        <li class="active">
                            <a href="javascript:;">Thêm đại lý</a>
                        </li>
                    </ol>
                </div>
                <div class="d_flex align_items_center">
                    <button type="submit" name="addAgency_action" class="btn_item btn btn_primary">
                        <i class="fa fa-save" aria-hidden="true"></i>
                        <span>Lưu</span>
                    </button>
                    <a class="btn_item btn_default" href="Agency">
                                    ...
                                    <div class="form_group status_wrap d_flex align_items_center">
                                        ...
                                        <div class="switch_status">
                                            <label for="status_value" class="status_toogle on">
                                                <input type="checkbox" data-id="" data-status="" name="agency_status" id="status_value" class="d_none">
                                    ...
                                    <div class="content_group">
                                        <div class="form_group d_flex align_items_center">
                                            ...
                                            <div class="form_input">
                                                <input class="form_control" value="" type="text" name="agency_fullname" id="agency_fullname" value="" placeholder="Tên người đăng ký" autocomplete="off" spellcheck="false">
                                            </div>
                                        </div>
                                        <div class="form_group d_flex align_items_center">
