            ...
            <div class="container_fluid d_flex justify_content_between align_items_center">
                <div class="d_flex align_items_end">
                    ...
                    <ol class="breadcrumb d_flex align_items_center">
                        ...
                        <li class="active">
                            <a href="javascript:;">Thêm thông tin hỗ trợ</a>
                        </li>
                    </ol>
                </div>
                <div class="d_flex align_items_center">
                    <button type="submit" name="addProductsp_action" class="btn_item btn btn_primary">
                        <i class="fa fa-save" aria-hidden="true"></i>
                        <span>Lưu</span>
                    </button>
                    <a class="btn_item btn_default" href="Productsp/add">
                            ...
                            <div class="tab_pane" id="tab_general">
                                <div class="form_group status_wrap d_flex align_items_center">
                                    ...
                                    <div class="switch_status">
                                        <label for="status_value" class="status_toogle">
                                            <input type="checkbox" name="prodsp_status" <?php {{ echo Validation::setValue("prodsp_status") == "on" ? "checked" : null; }} ?> id="status_value" class="d_none">
                                ...
                                <div class="content_group">
                                            ...
                                            <label for="prodsp_image">
                                                ...
                                                <span class="thumbNail small">
                                                    <img class="img_cover full_size" data-src-id="prodsp_image" src="<?php {{
                                                        /*-----------------------------------------*/
                                                        echo !empty(Validation::setValue("prodsp_image")) ? Validation::setValue("prodsp_image") : "./public/images/logo/no_image-50x50.png";
                                                        /*-----------------------------------------*/
                                                    }} ?>" alt="">
                                                </span>
                                            </label>
                                            ...
                                            <label for="prodsp_metaImg">
                                                ...
                                                <span class="thumbNail small" style="width: 300px; height: 300px;">
                                                    <img class="img_cover full_size" data-src-id="prodsp_metaImg" src="<?php {{
                                                        /*-----------------------------------------*/
                                                        echo !empty(Validation::setValue("prodsp_metaImg")) ? Validation::setValue("prodsp_metaImg") : "./public/images/logo/no_image-50x50.png";
                                                        /*-----------------------------------------*/
                                                    }} ?>" alt="">
                                                </span>
                                            </label>
                                    ...
                                    <div class="form_group d_flex align_items_center">
                                        ...
                                        <div class="form_input">
                                            <textarea class="form_control" name="prodsp_metaDesc" id="prodsp_metaDesc" placeholder="Thẻ mô tả (Meta desc)" spellcheck="false"><?php {{ echo Validation::setValue("prodsp_metaDesc"); }} ?></textarea>
                                    ...
                                    <div class="form_group d_flex align_items_center">
                                        ...
                                        <div class="form_input">
                                            <div class="google_title"><?php {{ echo Validation::setValue("prodsp_metaTitle"); }} ?></div>
                                    ...
                                    <div class="form_group seoUrl d_flex align_items_center">
                                        ...
                                        <div class="form_input">
                                            <input class="form_control" type="text" id="prodsp_seoUrl" value="<?php {{ echo Validation::setValue("prodsp_seoUrl"); }} ?>" placeholder="Đường dẫn SEO" autocomplete="off" spellcheck="false">
                                            <input type="hidden" name="prodsp_seoUrl" value="<?php {{ echo Validation::setValue("prodsp_seoUrl"); }} ?>">
