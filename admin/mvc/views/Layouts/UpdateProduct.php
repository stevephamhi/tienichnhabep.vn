    ...
    <form action="" method="POST">
        <div class="page_header">
            <div class="container_fluid d_flex justify_content_between align_items_center">
                ...
                <div class="d_flex align_items_center">
                    <button type="submit" <?php {{ echo empty($prodItem) ? "disable" : null; }} ?> name="updateProd_action" class="btn_item btn btn_primary">
        ...
        <div class="table_content container_fluid">
            <div class="panel_table">
                            ...
                            <div id="table_content">
                                ...
                                <div class="tab_content">
                                            ...
                                            <div class="switch_status">
                                                <label for="status_value" class="status_toogle on">
                                                    <input type="checkbox" name="prod_status" id="status_value" class="d_none" <?php {{
                                                        /* --------------------------------------------------- */
                                                        if(!empty(Validation::setValue("prod_status")))
                                                        { echo Validation::setValue("prod_status") == "on" ? "checked" : null; }
                                                        else
                                                        { echo $prodItem['prod_status'] == "on" ? "checked" : null; }
                                                        /* --------------------------------------------------- */
                                                    }} ?>>
                                            ...
                                            <div class="form_group d_flex align_items_center">
                                                ...
                                                <div class="form_input">
                                                    <input class="form_control" type="text" name="prod_name" id="prod_name" placeholder="Tên sản phẩm" autocomplete="off" spellcheck="false" value="<?php {{
                                                        /* --------------------------------------------------- */
                                                        if(!empty(Validation::setValue("prod_name")))
                                                        { echo Validation::setValue("prod_name"); }
                                                        else
                                                        { echo !empty($prodItem['prod_name']) ? $prodItem['prod_name'] : null; }
                                                        /* --------------------------------------------------- */
                                                    }} ?>">
                                            ...
                                            <div class="form_group d_flex align_items_center">
                                                ...
                                                <div class="form_input">
                                                    <textarea class="form_control" name="prod_desc" id="prod_desc" placeholder="Mô tả ngắn" spellcheck="false"><?php {{
                                                        /* --------------------------------------------------- */
                                                        if(Validation::setValue("prod_desc"))
                                                        { echo Validation::setValue("prod_desc"); }
                                                        else
                                                        { echo !empty($prodItem['prod_desc']) ? $prodItem['prod_desc'] : null; }
                                                        /* --------------------------------------------------- */
                                                    }} ?></textarea>
                                                </div>
                                            </div>
                                            <div class="form_group d_flex align_items_center">
                                                ...
                                                <div class="form_input">
                                                    <textarea class="form_control ckeditor" name="prod_content" id="prod_content" placeholder="Mô tả chi tiết" spellcheck="false"><?php {{
                                                        /* --------------------------------------------------- */
                                                        if(!empty(Validation::setValue("prod_content")))
                                                        { echo Validation::setValue("prod_content"); }
                                                        else
                                                        { echo !empty($prodItem['prod_content']) ? $prodItem['prod_content'] : $prodItem['prod_content']; }
                                                        /* --------------------------------------------------- */
                                                    }} ?></textarea>
                                                </div>
                                            </div>
                                            <div class="form_group d_flex align_items_center">
                                                ...
                                                <div class="form_input">
                                                    <input class="form_control" type="text" name="prod_metaTitle" id="prod_metaTitle" placeholder="Thẻ tiêu đề (Meta title)" autocomplete="off" spellcheck="false" value="<?php {{
                                                        /* --------------------------------------------------- */
                                                        if(!empty(Validation::setValue("prod_metaTitle")))
                                                        { echo Validation::setValue("prod_metaTitle"); }
                                                        else
                                                        { echo !empty($prodItem['prod_metaTitle']) ? $prodItem['prod_metaTitle'] : null; }
                                                        /* --------------------------------------------------- */
                                                    }} ?>">
                                            ...
                                            <div class="form_group d_flex align_items_center">
                                                ...
                                                <div class="form_input">
                                                    <textarea class="form_control" name="prod_metaDesc" id="prod_metaDesc" placeholder="Thẻ mô tả (Meta desc)" spellcheck="false" ><?php {{
                                                        /* --------------------------------------------------- */
                                                        if(!empty(Validation::setValue("prod_metaDesc")))
                                                        { echo Validation::setValue("prod_metaDesc"); }
                                                        else
                                                        { echo !empty($prodItem['prod_metaDesc']) ? $prodItem['prod_metaDesc'] : null; }
                                                        /* --------------------------------------------------- */
                                                    }} ?></textarea>
                                            ...
                                            <div class="form_group d_flex align_items_center">
                                                ...
                                                <div class="form_input">
                                                    <input class="form_control" type="text" name="prod_keywords" id="prod_keywords" placeholder="Thẻ mô tả (Meta desc)" autocomplete="off" spellcheck="false" value="<?php {{
                                                        /* --------------------------------------------------- */
                                                        if(!empty(Validation::setValue("prod_keywords")))
                                                        { echo Validation::setValue("prod_keywords"); }
                                                        else
                                                        { echo !empty($prodItem['prod_keywords']) ? $prodItem['prod_keywords'] : null; }
                                                        /* --------------------------------------------------- */
                                                    }} ?>">
                                            ...
                                            <div class="form_group d_flex align_items_center">
                                                ...
                                                <div class="form_input">
                                                    ...
                                                    <div class="google_url">
                                                        ...
                                                        <span class="url"><?php {{
                                                            /* --------------------------------------------------- */
                                                            if(!empty(Validation::setValue("prod_seoUrl")))
                                                            { echo Validation::setValue("prod_seoUrl"); }
                                                            else
                                                            { echo !empty($prodItem['prod_seoUrl']) ? $prodItem['prod_seoUrl'] : null; }
                                                            /* --------------------------------------------------- */
                                                        }} ?></span>
                                                    </div>
                                    ...
                                    <div class="tab_pane" id="tab_data">
                                            ...
                                            <div class="form_input">
                                                <label for="prod_avatar">
                                                    <input type="hidden" name="prod_avatar" id="prod_avatar" value="<?php {{
                                                        /* --------------------------------------------------- */
                                                        if(!empty(Validation::setValue("prod_avatar")))
                                                        { echo !empty(Validation::setValue("prod_avatar")) ? Validation::setValue("prod_avatar") : null; }
                                                        else
                                                        { echo !empty($prodItem['prod_avatar']) ? $prodItem['prod_avatar'] : null; }
                                                        /* --------------------------------------------------- */
                                                    }} ?>">
                                        ...
                                        <div class="form_group d_flex align_items_center">
                                            <label for="prod_banner" class="form_label" title='Chỉ xuất hiện khi sản phẩm là nổi bậc khi hiển thị ở trang chủ'><span style="color: #f00;">*</span>Banner highlight</label>
                                            <div class="form_input">
                                                <label for="prod_banner">
                                                    <input type="hidden" name="prod_banner" id="prod_banner" value="<?php {{
                                                        /* --------------------------------------------------- */
                                                        if(!empty(Validation::setValue("prod_banner")))
                                                        { echo !empty(Validation::setValue("prod_banner")) ? Validation::setValue("prod_banner") : null; }
                                                        else
                                                        { echo !empty($prodItem['prod_banner']) ? $prodItem['prod_banner'] : null; }
                                                        /* --------------------------------------------------- */
                                                    }} ?>">
                                                    <span>500px x 250px</span>
                                                    <span class="thumbNail small" style="width: 500px; height: 250px;">
                                                        <img data-src-id="prod_banner" class="img_cover full_size" alt="" src="<?php {{
                                                            ...
                                                            { echo !empty($prodItem['prod_banner']) ? $prodItem['prod_banner'] : "./public/images/logo/no_image-50x50.png"; }
                                                            /* --------------------------------------------------- */
                                                        }} ?>">
                                                    </span>
                                                </label>
                                                <div class="popover" style="transform: translate(0)">
                                                    <div class="popover_content d_flex align_items_center">
                                                        <a style="padding: 6.5px 10px 6.5px 12px; margin-right: 3px;" href="./public/plugins/filemanager/dialog.php?type=1&field_id=prod_banner" type="button" data-id-input-image="prod_avatar" class="button_image btn btn_primary iframe-btn" title="Thêm banner ảnh sản phẩm">
                                                            <i class="fa fa-pencil"></i>
                                                        </a>
                                            ...
                                            <div class="form_input">
                                                <div class="position_relative">
                                                    <input class="form_control valueLoadIframe" type="text" value="<?php {{
                                                        /* --------------------------------------------------- */
                                                        if(!empty(Validation::setValue("prod_video")))
                                                        { echo Validation::setValue("prod_video"); }
                                                        else
                                                        { echo !empty($prodItem['prod_video']) ? $prodItem['prod_video'] : null; }
                                                        /* --------------------------------------------------- */
                                                ...
                                                <div class="iframe_box">
                                                    ...
                                                    <?php else : ?>
                                                        <?php if(!empty($prodItem['prod_video'])) : ?>
                                                            <iframe src="<?php {{ echo $prodItem['prod_video']; }} ?>" frameborder="0"></iframe>
                                                        <?php endif; ?>
                                                    <?php endif; ?>
                                                </div>
                                        ...
                                        <div class="form_group d_flex align_items_center">
                                            ...
                                            <div class="form_input">
                                                <input class="form_control price_input" data-price-name="prod_currentPrice" type="text" id="prod_currentPrice" placeholder="Giá bán" autocomplete="off" spellcheck="false" value="<?php {{
                                                    /* --------------------------------------------------- */
                                                    if(!empty(Validation::setValue("prod_currentPrice")))
                                                    { echo Validation::setValue("prod_currentPrice"); }
                                                    else
                                                    { echo !empty($prodItem['prod_currentPrice']) ? $prodItem['prod_currentPrice'] : null; }
                                                    /* --------------------------------------------------- */
                                                }} ?>">
                                        ...
                                        <div class="form_group d_flex align_items_center">
                                            ...
                                            <div class="form_input">
                                                <input class="form_control price_input" data-price-name="prod_oldPrice" type="text" id="prod_oldPrice" placeholder="Giá cũ" autocomplete="off" spellcheck="false" value="<?php {{
                                                    /* --------------------------------------------------- */
                                                    if(!empty(Validation::setValue("prod_oldPrice")))
                                                    {  echo Validation::setValue("prod_oldPrice"); }
                                                    else
                                                    { echo !empty($prodItem['prod_oldPrice']) ? $prodItem['prod_oldPrice'] : null; }
                                                    /* --------------------------------------------------- */
                                                }} ?>">
                                        ...
                                        <div class="form_group d_flex align_items_center">
                                            ...
                                            <div class="form_input">
                                                <input class="form_control" type="text" name="prod_model" id="prod_model" placeholder="Mã sản phẩm [ Model ]" autocomplete="off" spellcheck="false" value="<?php {{
                                                    /* --------------------------------------------------- */
                                                    if(!empty(Validation::setValue("prod_model")))
                                                    { echo Validation::setValue("prod_model"); }
                                                    else
                                                    { echo !empty($prodItem['prod_model']) ? $prodItem['prod_model'] : null; }
                                                    /* --------------------------------------------------- */
                                                }} ?>">
                                            </div>
                                        </div>
                                        <div class="form_group d_flex align_items_center">
                                            ...
                                            <div class="form_input">
                                                <input class="form_control" type="number" name="prod_amount" id="prod_amount" placeholder="Số lượng sản phẩm" autocomplete="off" spellcheck="false" value="<?php {{
                                                    /* --------------------------------------------------- */
                                                    if(!empty(Validation::setValue("prod_amount")))
                                                    { echo Validation::setValue("prod_amount"); }
                                                    else
                                                    { echo !empty($prodItem['prod_amount']) ? $prodItem['prod_amount'] : null; }
                                                    /* --------------------------------------------------- */
                                                }} ?>">
                                        ...
                                        <div class="form_group d_flex align_items_center">
                                            ...
                                            <div class="form_input">
                                                <input class="form_control" type="number" name="prod_minimun_amount" id="prod_minimun_amount" placeholder="Số lượng sản phẩm tối thiểu khách phải mua" autocomplete="off" spellcheck="false" value="<?php {{
                                                    /* --------------------------------------------------- */
                                                    if(!empty(Validation::setValue("prod_minimun_amount")))
                                                    { echo Validation::setValue("prod_minimun_amount"); }
                                                    else
                                                    { echo !empty($prodItem['prod_minimun_amount']) ? $prodItem['prod_minimun_amount'] : null; }
                                                    /* --------------------------------------------------- */
                                                }} ?>">
                                        ...
                                        <div class="form_group d_flex align_items_center">
                                            ...
                                            <div class="form_input">
                                                <input class="form_control" type="text" name="prod_sku" id="prod_sku" placeholder="Đơn vị lưu kho [ Stock Keeping Unit ]" autocomplete="off" spellcheck="false" value="<?php {{
                                                    /* --------------------------------------------------- */
                                                    if(!empty(Validation::setValue("prod_sku")))
                                                    { echo Validation::setValue("prod_sku"); }
                                                    else
                                                    { echo !empty($prodItem['prod_sku']) ? $prodItem['prod_sku'] : null; }
                                                    /* --------------------------------------------------- */
                                                }} ?>">
                                            </div>
                                        </div>
                                        <div class="form_group d_flex align_items_center">
                                            ...
                                            <div class="form_input">
                                                <input class="form_control" type="text" name="prod_order" id="prod_order" placeholder="Thứ tự hiển thị" autocomplete="off" spellcheck="false" value="<?php {{
                                                    /* --------------------------------------------------- */
                                                    if(!empty(Validation::setValue("prod_order")))
                                                    { echo Validation::setValue("prod_order"); }
                                                    else
                                                    { echo !empty($prodItem['prod_order']) ? $prodItem['prod_order'] : null; }
                                                    /* --------------------------------------------------- */
                                                }} ?>">
                                            </div>
                                        </div>
                                        <div class="form_group d_flex align_items_center">
                                            ...
                                            <div class="form_input">
                                                <select class="form_control" name="prod_stock_status" id="prod_stock_status">
                                                    ...
                                                    <option value="1" <?php {{
                                                        /* --------------------------------------------------- */
                                                        if(!empty(Validation::setValue("prod_stock_status")))
                                                        { echo Validation::setValue("prod_stock_status") == "1" ? "selected" : null; }
                                                        else
                                                        { echo $prodItem['prod_stock_status'] == "1" ? "selected" : null; }
                                                        /* --------------------------------------------------- */
                                                    }} ?>>Còn hàng</option>
                                                    <option value="2" <?php {{
                                                        /* --------------------------------------------------- */
                                                        if(!empty(Validation::setValue("prod_stock_status")))
                                                        { echo Validation::setValue("prod_stock_status") == "2" ? "selected" : null; }
                                                        else
                                                        { echo $prodItem['prod_stock_status'] == "2" ? "selected" : null; }
                                                        /* --------------------------------------------------- */
                                                    }} ?>>Hết hàng</option>
                                                    <option value="3" <?php {{
                                                        /* --------------------------------------------------- */
                                                        if(!empty(Validation::setValue("prod_stock_status")))
                                                        { echo Validation::setValue("prod_stock_status") == "3" ? "selected" : null; }
                                                        else
                                                        { echo $prodItem['prod_stock_status'] == "3" ? "selected" : null; }
                                                        /* --------------------------------------------------- */
                                                    }} ?>>Sản phẩm mới</option>
                                                    <option value="4" <?php {{
                                                        /*------------------------------------------------------*/
                                                        if(!empty(Validation::setValue("prod_stock_status")))
                                                        { echo Validation::setValue("prod_stock_status") == "4" ? "selected" : null; }
                                                        else
                                                        { echo $prodItem['prod_stock_status'] == "4" ? "selected" : null; }
                                                        /*------------------------------------------------------*/
                                                    }} ?>>Tin đồn</option>
                                                    <option value="5" <?php {{
                                                        /*------------------------------------------------------*/
                                                        if(!empty(Validation::setValue("prod_stock_status")))
                                                        { echo Validation::setValue("prod_stock_status") == "5" ? "selected" : null; }
                                                        else
                                                        { echo $prodItem['prod_stock_status'] == "5" ? "selected" : null; }
                                                        /*------------------------------------------------------*/
                                                    }} ?>>Sắp về</option>
                                                    <option value="6" <?php {{
                                                        /*------------------------------------------------------*/
                                                        if(!empty(Validation::setValue("prod_stock_status")))
                                                        { echo Validation::setValue("prod_stock_status") == "6" ? "selected" : null; }
                                                        else
                                                        { echo $prodItem['prod_stock_status'] == "6" ? "selected" : null; }
                                                        /*------------------------------------------------------*/
                                        ...
                                        <div class="form_group d_flex align_items_center">
                                            ...
                                            <div class="form_input">
                                                <input class="form_control" type="text" name="prod_deliveryPromo" id="prod_deliveryPromo" placeholder="Khuyến mãi giao hàng [Miễn phí vận chuyển]" autocomplete="off" spellcheck="false" value="<?php {{
                                                    /* --------------------------------------------------- */
                                                    if(!empty(Validation::setValue("prod_deliveryPromo")))
                                                    { echo Validation::setValue("prod_deliveryPromo"); }
                                                    else
                                                    { echo !empty($prodItem['prod_deliveryPromo']) ? $prodItem['prod_deliveryPromo'] : null; }
                                                    /* --------------------------------------------------- */
                                                }} ?>">
                                            </div>
                                        </div>
                                            ...
                                            <div class="form_input">
                                                <label for="yes_for_agents">
                                                    <input type="radio" <?php {{
                                                        /*------------------------------------------------------*/
                                                        if(!empty(Validation::setValue("prod_for_agents")))
                                                        {  echo Validation::setValue("prod_for_agents") == "1" ? "checked" : null; }
                                                        else
                                                        { echo $prodItem['prod_for_agents'] == "1" ? "checked" : null; }
                                                        /*------------------------------------------------------*/
                                                    }} ?> name="prod_for_agents[]" id="yes_for_agents" value="1">
                                                    <span>Có</span>
                                                </label>
                                                <label for="no_for_agents">
                                                    <input type="radio" <?php {{
                                                        /*------------------------------------------------------*/
                                                        if(!empty(Validation::setValue("prod_for_agents")))
                                                        { echo Validation::setValue("prod_for_agents") == "2" ? "checked" : null; }
                                                        else
                                                        { echo $prodItem['prod_for_agents'] == "2" ? "checked" : null; }
                                                        /*------------------------------------------------------*/
                                                    }} ?> name="prod_for_agents[]" id="no_for_agents" value="2">
                                                    <span>Không</span>
                                                </label>
                                        ...
                                        <div class="form_group d_flex align_items_center">
                                            ...
                                            <div class="form_input">
                                                <label for="yes_installment">
                                                    <input type="radio" <?php {{
                                                        /*------------------------------------------------------*/
                                                        if(!empty(Validation::setValue("prod_installment")))
                                                        {  echo Validation::setValue("prod_installment") == "1" ? "checked" : null; }
                                                        else
                                                        { echo $prodItem['prod_installment'] == "1" ? "checked" : null; }
                                                        /*------------------------------------------------------*/
                                                    }} ?> name="prod_installment[]" id="yes_installment" value="1">
                                                    <span>Có</span>
                                                </label>
                                                <label for="no_installment">
                                                    <input type="radio" <?php {{
                                                        /*------------------------------------------------------*/
                                                        if(!empty(Validation::setValue("prod_installment")))
                                                        { echo Validation::setValue("prod_installment") == "2" ? "checked" : null; }
                                                        else
                                                        { echo $prodItem['prod_installment'] == "2" ? "checked" : null; }
                                                        /*------------------------------------------------------*/
                                                    }} ?> name="prod_installment[]" id="no_installment" value="2">
                                                    <span>Không</span>
                                                </label>
                                                <div class="form_installment_rate d_flex align_items_center" style="font-weight: bold;">
                                                    <input type="text" class="form_control" value="<?php {{
                                                        ...
                                                        { echo !empty($prodItem['prod_installment_rate']) ? $prodItem['prod_installment_rate'] : null; }
                                                        /* --------------------------------------------------- */
                                        ...
                                        <div class="form_group d_flex align_items_center">
                                            ...
                                            <div class="form_input">
                                                <label for="yes_installment">
                                                    <input type="radio" <?php {{
                                                        /*------------------------------------------------------*/
                                                        if(!empty(Validation::setValue("prod_avt_tax")))
                                                        { echo Validation::setValue("prod_avt_tax") == "1" ? "checked" : null; }
                                                        else
                                                        { echo $prodItem['prod_avt_tax'] == "1" ? "checked" : null; }
                                                        /*------------------------------------------------------*/
                                                    }} ?> name="prod_avt_tax[]" id="yes_avt_tax" value="1">
                                                    <span>Có</span>
                                                </label>
                                                <label for="no_installment">
                                                    <input type="radio" <?php {{
                                                        /*------------------------------------------------------*/
                                                        if(!empty(Validation::setValue("prod_avt_tax")))
                                                        { echo Validation::setValue("prod_avt_tax") == "2" ? "checked" : null; }
                                                        else
                                                        { echo $prodItem['prod_avt_tax'] == "2" ? "checked" : null; }
                                                        /*------------------------------------------------------*/
                                                    }} ?> name="prod_avt_tax[]" id="no_avt_tax" value="2">
                                                    <span>Không</span>
                                                </label>
                                        ...
                                        <div class="form_group d_flex align_items_center">
                                            ...
                                            <div class="form_input">
                                                <label for="yes_installment">
                                                    <input type="radio" <?php {{
                                                        /*------------------------------------------------------*/
                                                        if(!empty(Validation::setValue("prod_liquidation")))
                                                        { echo Validation::setValue("prod_liquidation") == "1" ? "checked" : null; }
                                                        else
                                                        { echo $prodItem['prod_liquidation'] == "1" ? "checked" : null; }
                                                        /*------------------------------------------------------*/
                                                    }} ?> name="prod_liquidation[]" id="yes_avt_tax" value="1">
                                                    <span>Có</span>
                                                </label>
                                                <label for="no_installment">
                                                    <input type="radio" <?php {{
                                                        /*------------------------------------------------------*/
                                                        if(!empty(Validation::setValue("prod_liquidation")))
                                                        { echo Validation::setValue("prod_liquidation") == "2" ? "checked" : null; }
                                                        else
                                                        { echo $prodItem['prod_liquidation'] == "2" ? "checked" : null; }
                                                        /*------------------------------------------------------*/
                                                    }} ?> name="prod_liquidation[]" id="no_avt_tax" value="2">
                                                    <span>Không</span>
                                                </label>
                                                <?php {{ echo Validation::formError("prod_liquidation"); }} ?>
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <div class="form_input">
                                                <input class="form_control" type="text" id="prod_ties_brand_id" value="<?php {{
                                                    ...
                                                    if((!empty(Validation::setValue("prod_ties_brand_id"))) && (!empty($listBrand))) {
                                                        ...
                                                        foreach($listBrand as $brandItem) {
                                                            echo $brandItem['brand_id'] == $prodItem['prod_ties_brand_id'] ? $brandItem['brand_name'] : null;
                                                        }
                                                    }
                                                    /* --------------------------------------------------- */
                                                ...
                                                <input type="hidden" name="prod_ties_brand_id" value="<?php {{
                                                    ...
                                                    if((!empty(Validation::setValue("prod_ties_brand_id"))) && (!empty($listBrand))) {
                                                        ...
                                                        if(!empty($brandItem)) {
                                                            foreach($listBrand as $brandItem) {
                                                                echo $brandItem['brand_id'] == $prodItem['prod_ties_brand_id'] ? $brandItem['brand_id'] : null;
                                                            }
                                                        } else {
                                                            echo null;
                                                        }
                                                ...
                                                <div class="form_list_wrap">
                                                    <div class="list">
                                                        <?php if(!empty($listCateProd)) : ?>
                                                                ...
                                                                <label for="cateProd_<?php {{ echo $cateProdItem['cateProd_id']; }} ?>" class="item d_flex align_items_center">
                                                                    <input type="checkbox" name="cateProdId[]" class="cateProdId_checkItem" <?php {{
                                                                        ...
                                                                        if(!empty(Validation::setValue("cateProdId"))) {
                                                                            ...
                                                                            if(!empty($prod_listId_cateProd_ties)) {
                                                                                foreach(json_decode($prodItem['prod_listId_cateProd_ties']) as $__cateProdItem) {
                                                                                    echo $__cateProdItem == $cateProdItem['cateProd_id'] ? "checked" : null;
                                                                                }
                                                                            } else {
                                                                                echo null;
                                                            ...
                                                            <?php endforeach; ?>
                                                        <?php else : ?>
                                                            <p class="data_empty_notification text_left">Bạn chưa có danh mục sản phẩm nào !</p>
                                                        <?php endif; ?>
                                                    </div>
                                                </div>
                                                                ...
                                                                <label for="newsIntro_<?php {{ echo $newsItem['news_id']; }} ?>" class="item d_flex align_items_center">
                                                                    <input type="checkbox" name="newsIntroId[]" class="newsIntroId_checkItem" <?php {{
                                                                        ...
                                                                        if(!empty(Validation::setValue("newsIntroId"))) {
                                                                            ...
                                                                            $prod_listId_newsIntro_ties = json_decode($prodItem['prod_listId_newsIntro_ties']);
                                                                            if(!empty($prod_listId_newsIntro_ties)) {
                                                                                foreach($prod_listId_newsIntro_ties as $__newsIntroItem) {
                                                                                    echo $__newsIntroItem == $newsItem['news_id'] ? "checked" : null;
                                                                                }
                                                                            } else {
                                                                                echo null;
                                                                ...
                                                                <label for="newsTutorial_<?php {{ echo $newsItem['news_id']; }} ?>" class="item d_flex align_items_center">
                                                                    <input type="checkbox" name="newsIdTutorial[]" class="newsIdTutorial_checkItem" <?php {{
                                                                        ...
                                                                        if(!empty(Validation::setValue("newsIdTutorial"))) {
                                                                            ...
                                                                            $prod_listId_newsTutorial_ties = json_decode($prodItem['prod_listId_newsTutorial_ties']);
                                                                            if(!empty($prod_listId_newsTutorial_ties)) {
                                                                                foreach($prod_listId_newsTutorial_ties as $__newsTutorialItem) {
                                                                                    echo $__newsTutorialItem == $newsItem['news_id'] ? "checked" : null;
                                                                                }
                                                                            } else {
                                                                                echo null;
                                                ...
                                                <div class="position_relative">
                                                    <div class="form_list_wrap" style="height: 150px;">
                                                        <ul class="list_content">
                                                            <?php if(!empty(Validation::setValue("prod_listId_recomment"))) : ?>
                                                                <?php $numRow = 0; foreach(Validation::setValue("prod_listId_recomment") as $__prod_item__) : ?>
                                                                    <li class="item">
                                                            ...
                                                            <?php else : ?>
                                                                <?php if(!empty($listProdRecomment)) : ?>
                                                                    <?php $numRow = 0; foreach($listProdRecomment as $__prod_item__) : ?>
                                                                        <li class="item">
                                                                            <span><?php {{ echo $__prod_item__['prod_name']; }} ?></span>
                                                                            <span class="close" data-id="<?php {{ echo $__prod_item__['prod_id']; }} ?>"></span>
                                                                            <input type="hidden" name="prod_listId_recomment[<?php {{ echo $numRow; }} ?>][prod_id]" value="<?php {{ echo $__prod_item__['prod_id']; }} ?>">
                                            ...
                                            <table class="table_images table">
                                                ...
                                                <tbody>
                                                    <?php if(!empty(Validation::setValue("prod_image_desc"))) : ?>
                                                        <?php $numRow = 0; foreach(Validation::setValue("prod_image_desc") as $prod_image_desc_item) : ?>
                                                        ...
                                                        <?php $numRow ++; endforeach; ?>
                                                    <?php else : ?>
                                                        <?php if(!empty($listProdImgDesc)) : ?>
                                                            <?php $numRow = 0; foreach($listProdImgDesc as $prod_image_desc_item) : ?>
                                                                <tr id="image_row<?php {{ echo $numRow; }} ?>">
                                                                    <td class="position_relative">
                                                                        <div class="thumbNail">
                                                                            <img data-src-id="input_image<?php {{ echo $numRow; }} ?>" src="<?php {{
                                                                                /*----------------------------------------------*/
                                                                                echo !empty($prod_image_desc_item['prod_listImg_ties_src']) ? $prod_image_desc_item['prod_listImg_ties_src'] : "./public/images/logo/no_image-50x50.png";
                                                                                /*----------------------------------------------*/
                                                                            }} ?>" alt="">
                                                                        </div>
                                                                        <div class="popover position_absolute">
                                                                        ...
                                                                        <input type="hidden" name="prod_image_desc[<?php {{ echo $numRow; }} ?>][image]" value="<?php {{
                                                                            /*----------------------------------------------*/
                                                                            echo !empty($prod_image_desc_item['prod_listImg_ties_src']) ? $prod_image_desc_item['prod_listImg_ties_src'] : null;
                                                                            /*----------------------------------------------*/
                                                                        }} ?>" id="input_image<?php {{ echo $numRow; }} ?>">
                                                                    </td>
                                                                    <td>
                                                                        <input type="number" min="0" name="prod_image_desc[<?php {{ echo $numRow; }} ?>][sort_order]" value="<?php {{
                                                                            /*----------------------------------------------*/
                                                                            echo !empty($prod_image_desc_item['prod_listImg_ties_order']) ? $prod_image_desc_item['prod_listImg_ties_order'] : null;
                                                                            /*----------------------------------------------*/
                                                                        }} ?>" placeholder="Sắp xếp" class="form_control">
                                                                    </td>
                                                                    <td>
                                    ...
                                    <div class="tab_pane" id="tab_attribute">
                                        <div class="form_group d_flex align_items_center" style="background-color: #eee;">
                                            ...
                                            <div class="form_input">
                                                <textarea class="form_control ckeditor" name="prod_old_content_ties" id="prod_old_content_ties" placeholder="Sản phẩm cũ liên quan" spellcheck="false"><?php {{
                                                    /*----------------------------------------------*/
                                                    if(!empty(Validation::setValue("prod_old_content_ties")))
                                                    { echo Validation::setValue("prod_old_content_ties"); }
                                                    else
                                                    { echo !empty($prodItem['prod_old_content_ties']) ? $prodItem['prod_old_content_ties'] : null; }
                                                    /*----------------------------------------------*/
                                                }} ?></textarea>
                                        ...
                                        <div class="form_group d_flex align_items_center">
                                            ...
                                            <div class="form_input">
                                                <textarea class="form_control ckeditor" name="prod_intro_content" id="prod_intro_content" placeholder="Giới thiệu nổi bậc" spellcheck="false"><?php {{
                                                    /*----------------------------------------------*/
                                                    if(!empty(Validation::setValue("prod_intro_content")))
                                                    { echo Validation::setValue("prod_intro_content"); }
                                                    else
                                                    { echo !empty($prodItem['prod_intro_content']) ? $prodItem['prod_intro_content'] : null; }
                                                    /*----------------------------------------------*/
                                                }} ?></textarea>
                                                <p class="caption" style="margin-top: 20px;">Hiển thị ngay bên cạnh hình ảnh sản phẩm</p>
                                            </div>
                                        </div>
                                        <div class="form_group d_flex align_items_center">
                                            ...
                                            <div class="form_input">
                                                <textarea class="form_control ckeditor" name="prod_specifications_content" id="prod_specifications_content" placeholder="Mô tả thông số kỹ thuật" spellcheck="false"><?php {{
                                                    /*----------------------------------------------*/
                                                    if(!empty(Validation::setValue("prod_specifications_content")))
                                                    { echo Validation::setValue("prod_specifications_content"); }
                                                    else
                                                    { echo !empty($prodItem['prod_specifications_content']) ? $prodItem['prod_specifications_content'] : null; }
                                                    /*----------------------------------------------*/
                                                }} ?></textarea>
                                                <p class="caption" style="margin-top: 20px;">Khởi tạo table và thể hiện</p>
                                            </div>
                                        ...
                                        <div class="form_group d_flex align_items_center">
                                            ...
                                            <div class="form_input">
                                                <textarea class="form_control ckeditor" name="prod_outstanding_features" id="prod_outstanding_features" placeholder="Mô tả tính năng nổi bậc" spellcheck="false"><?php {{
                                                    /*----------------------------------------------*/
                                                    if(!empty(Validation::setValue("prod_outstanding_features")))
                                                    { echo Validation::setValue("prod_outstanding_features"); }
                                                    else
                                                    { echo !empty($prodItem['prod_outstanding_features']) ? $prodItem['prod_outstanding_features'] : null; }
                                                    /*----------------------------------------------*/
                                                }} ?></textarea>
                                                <p class="caption" style="margin-top: 20px;">Khởi tạo table và thể hiện</p>
                                            </div>
                                            ...
                                            <table class="flash_sale table">
                                                ...
                                                <tbody>
                                                    <?php if(!empty(Validation::setValue("prod_flashSale"))) : ?>
                                                        <?php $numRow = 0; foreach(Validation::setValue("prod_flashSale")  as $prodFlashSaleItem) : ?>
                                                        ...
                                                        <?php $numRow ++; endforeach; ?>
                                                    <?php else : ?>
                                                        <?php if(!empty($listProdFlashSale)) : ?>
                                                            <?php $numRow = 0; foreach($listProdFlashSale as $prodFlashSaleItem) : ?>
                                                                <tr id="flashSale_row<?php {{ echo $numRow; }} ?>">
                                                                    <td>
                                                                        <select class="form_control" name="prod_flashSale[<?php {{ echo $numRow; }} ?>][customer_group_id]">
                                                                            <option value="1" <?php {{ echo $prodFlashSaleItem == '1' ? "checked" : null; }} ?> >Mặc định</option>
                                                                    ...
                                                                    <td>
                                                                        <input class="form_control" type="number" value="<?php {{ echo $prodFlashSaleItem['prod_flashsale_order']; }} ?>" name="prod_flashSale[<?php {{ echo $numRow; }} ?>][order]" placeholder="Độ ưu tiên" autocomplete="off" spellcheck="false">
                                                                    </td>
                                                                    <td>
                                                                        <input class="form_control price_input" value="<?php {{ echo $prodFlashSaleItem['prod_flashsale_price']; }} ?>" name="prod_flashSale[<?php {{ echo $numRow; }} ?>][price]" type="text" placeholder="Giá khuyến mãi" autocomplete="off" spellcheck="false">
                                                                    </td>
                                                                    <td>
                                                                        <div class="input_group">
                                                                            <input class="form_control dateStart_value" value="<?php {{ echo Format::formatTimeDateInput($prodFlashSaleItem['prod_flashsale_dateStart']); }} ?>" type="date" name="prod_flashSale[<?php {{ echo $numRow; }} ?>][date_start]" placeholder="Thời gian bắt đầu" autocomplete="off" spellcheck="false">
                                                                        </div>
                                                                    </td>
                                                                    <td>
                                                                        <div class="input_group">
                                                                            <input class="form_control dateEnd_value" value="<?php {{ echo Format::formatTimeDateInput($prodFlashSaleItem['prod_flashsale_dateEnd']); }} ?>" type="date" name="prod_flashSale[<?php {{ echo $numRow; }} ?>][date_end]" placeholder="Thời gian kết thúc" autocomplete="off" spellcheck="false">
                                                                        </div>
                                                                    </td>
                                                                    <td>
                                                                        <select name="prod_flashSale[<?php {{ echo $numRow; }} ?>][status]" class="form_control">
                                                                            <option value="on"  <?php {{ echo $prodFlashSaleItem['prod_flashsale_status'] == "on"  ? "selected" : null; }} ?>>Bật</option>
                                                                            <option value="off" <?php {{ echo $prodFlashSaleItem['prod_flashsale_status'] == "off" ? "selected" : null; }} ?>>Tắt</option>
                                                                        </select>
                                                                    </td>
                                                                    <td>
                                                                        <button type="button" class="btn btn_danger btnClear">
                                    ...
                                    <div class="tab_pane" id="tab_special">
                                        <div class="form_group d_flex align_items_center">
                                            <label for="prod_discout_content" class="form_label">Bảng khuyến mãi</label>
                                            <div class="form_input">
                                                <textarea class="form_control ckeditor" name="prod_discout_content" id="prod_discout_content" placeholder="Khuyến mãi kèm theo sản phẩm" spellcheck="false"><?php {{
                                                    /*----------------------------------------------*/
                                                    if(!empty(Validation::setValue("prod_discout_content")))
                                                    { echo Validation::setValue("prod_discout_content"); }
                                                    else
                                                    { echo !empty($prodItem['prod_discout_content']) ? $prodItem['prod_discout_content'] : null; }
                                                    /*----------------------------------------------*/
                                                }} ?></textarea>
                ...
                <?php else : ?>
                    <p class="data_empty_notification">Không tồn tại sản phẩm này !</p>
                <?php endif; ?>
            </div>
        </div>
    </form>
