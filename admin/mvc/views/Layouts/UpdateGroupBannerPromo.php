        ...
        <div class="page_header">
            <div class="container_fluid d_flex justify_content_between align_items_center">
                <div class="d_flex align_items_end">
                    <h1>Nhóm banner khuyến mãi</h1>
                    <ol class="breadcrumb d_flex align_items_center">
                        <li>
                            <a href="Home">Trang chủ</a>
                        </li>
                        <li class="active">
                            <a href="javascript:;">Cập nhật nhóm banner khuyến mãi</a>
                        </li>
                    </ol>
                </div>
            ...
            <div class="panel_table">
                <div class="panel_heading">
                    <h2 class="panel_title">
                        ...
                        <span>Cập nhật nhóm banner khuyến mãi</span>
                    </h2>
                </div>
                                        ...
                                        <div class="switch_status">
                                            <label for="status_value" class="status_toogle on">
                                                <input type="checkbox" <?php {{
                                                    /*-----------------------------------------------------------------------*/
                                                   if(!empty(Validation::setValue("bannerGroup_status_promo")))
                                        ...
                                        <div class="form_group d_flex align_items_center">
                                            ...
                                            <div class="form_input">
                                                <input class="form_control" type="text" name="bannerGroup_name_promo" id="bannerGroup_name_promo" value="<?php {{
                                                    /*-----------------------------------------------------------------------*/
                                                    if(!empty(Validation::setValue("bannerGroup_name_promo")))
                                        ...
                                        <div class="form_group d_flex align_items_center">
                                            ...
                                            <div class="form_input">
                                                <select class="form_control" name="bannerGroup_customerGroup_ties_promo" id="">
                                                    <option value="1" <?php {{
                                                        /*-----------------------------------------------------------------------*/
                                                        if(!empty(Validation::setValue("bannerGroup_customerGroup_ties_promo")))
                                                        { echo Validation::setValue("bannerGroup_customerGroup_ties_promo") == "1" ? "selected" : null; }
                                                        else
                                                    ...
                                                    <option value="2" <?php {{
                                                        /*-----------------------------------------------------------------------*/
                                                        if(!empty(Validation::setValue("bannerGroup_customerGroup_ties_promo")))
                                                        { echo Validation::setValue("bannerGroup_customerGroup_ties_promo") == "2" ? "selected" : null; }
                                                        else
                                        ...
                                        <div class="form_group d_flex align_items_center">
                                            ...
                                            <div class="form_input">
                                                <input class="form_control" type="date" name="bannerGroup_startDate_promo" id="bannerGroup_startDate_promo" value="<?php {{
                                                    /*-----------------------------------------------------------------------*/
                                                    if(!empty(Validation::setValue("bannerGroup_startDate_promo")))
                                        ...
                                        <div class="form_group d_flex align_items_center">
                                            ...
                                            <div class="form_input">
                                                <input class="form_control" type="date" name="bannerGroup_endDate_promo" id="bannerGroup_endDate_promo" value="<?php {{
                                                    /*-----------------------------------------------------------------------*/
                                                    if(!empty(Validation::setValue("bannerGroup_endDate_promo")))
                                        ...
                                        <div class="form_group d_flex align_items_center">
                                            ...
                                            <div class="form_input">
                                                <input class="form_control" type="number" name="bannerGroup_order_promo" id="bannerGroup_order_promo" value="<?php {{
                                                    /*-----------------------------------------------------------------------*/
                                                    if(!empty(Validation::setValue("bannerGroup_order_promo")))
                                    ...
                                    <table class="table mini_banner_banner_table">
                                        ...
                                        <tbody>
                                            <?php {{ if(!empty(Validation::setValue("listBannerPromo"))) {
                                                $orderRow = 0;
                                                foreach(Validation::setValue("listBannerPromo") as $bannerItem) {
                                                ?>
                                                    ...
                                                    <td>
                                                        <div class="form_group d_flex align_items_center">
                                                            ...
                                                            <div class="form_input grid_column_9">
                                                                <input class="form_control" type="text" value="<?php {{ echo !empty($bannerItem['title']) ? $bannerItem['title'] : null; }} ?>" name="bannerPromo[<?php {{ echo $orderRow; }} ?>][title]" placeholder="Tiêu đề" autocomplete="off" spellcheck="false">
                                                            </div>
                                                        </div>
                                                        <div class="form_group d_flex align_items_center">
                                                            <label for="" class="form_label grid_column_2">Mô tả</label>
                                                            <div class="form_input grid_column_9">
                                                                <input class="form_control" type="text" value="<?php {{ echo !empty($bannerItem['desc']) ? $bannerItem['desc'] : null; }} ?>" name="bannerPromo[<?php {{ echo $orderRow; }} ?>][desc]" placeholder="Mô tả" autocomplete="off" spellcheck="false">
                                                            </div>
                                                        </div>
                                                        <div class="form_group d_flex align_items_center">
                                                            <label for="" class="form_label grid_column_2">Đường dẫn</label>
                                                            <div class="form_input grid_column_9">
                                                                <input class="form_control" type="text" value="<?php {{ echo !empty($bannerItem['link']) ? $bannerItem['link'] : null; }} ?>" name="bannerPromo[<?php {{ echo $orderRow; }} ?>][link]" placeholder="Đường dẫn" autocomplete="off" spellcheck="false">
                                                            </div>
                                                        </div>
                                                        ...
                                                        <tr id="bannerPromoImgRow<?php {{ echo $orderRow; }} ?>">
                                                            <td>
                                                                <div class="form_group d_flex align_items_center">
                                                                    <label for="title" class="form_label grid_column_2">Tiêu đề</label>
                                                                    <div class="form_input grid_column_9">
                                                                        <input class="form_control" type="text" value="<?php {{ echo !empty($bannerItem['banner_name']) ? $bannerItem['banner_name'] : null; }} ?>" name="bannerPromo[<?php {{ echo $orderRow; }} ?>][title]" placeholder="Tiêu đề" autocomplete="off" spellcheck="false">
                                                                    </div>
                                                                </div>
                                                                <div class="form_group d_flex align_items_center">
                                                                    <label for="" class="form_label grid_column_2">Mô tả</label>
                                                                    <div class="form_input grid_column_9">
                                                                        <input class="form_control" type="text" value="<?php {{ echo !empty($bannerItem['banner_desc']) ? $bannerItem['banner_desc'] : null; }} ?>" name="bannerPromo[<?php {{ echo $orderRow; }} ?>][desc]" placeholder="Mô tả" autocomplete="off" spellcheck="false">
                                                                    </div>
                                                                </div>
                                                                <div class="form_group d_flex align_items_center">
                                                                    <label for="" class="form_label grid_column_2">Đường dẫn</label>
                                                                    <div class="form_input grid_column_9">
                                                                        <input class="form_control" type="text" value="<?php {{ echo !empty($bannerItem['banner_link']) ? $bannerItem['banner_link'] : null; }} ?>" name="bannerPromo[<?php {{ echo $orderRow; }} ?>][link]" placeholder="Đường dẫn" autocomplete="off" spellcheck="false">
                                                                    </div>
                                                                </div>
                                                                <div class="form_group d_flex align_items_center" style="border-bottom: 1px solid #E5E5E5;">
                                                                    <label for="" class="form_label grid_column_2"></label>
