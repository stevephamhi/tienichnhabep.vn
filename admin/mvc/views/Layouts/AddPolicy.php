...
<main class="main_content">
    <form action="" method="POST">
            ...
            <div class="container_fluid d_flex justify_content_between align_items_center">
                <div class="d_flex align_items_end">
                    ...
                    <ol class="breadcrumb d_flex align_items_center">
                        ...
                        <li class="active">
                            <a href="">Thêm chính sách</a>
                        </li>
                    </ol>
                </div>
                <div class="d_flex align_items_center">
                    <button type="submit" name="addPolicy_action" class="btn_item btn btn_primary">
                    ...
                    <a class="btn_item btn_default" href="Policy/add">
        ...
        <?php if(!empty($statusActionPolicy)) : ?>
                                ...
                                <div class="tab_pane" id="tab_general">
                                    ...
                                    <div class="content_group">
                                        ...
                                        <div class="form_group d_flex align_items_center">
                                            ...
                                            <div class="form_input">
                                                <div class="google_title"><?php {{ echo Validation::setValue("policy_metaTitle"); }} ?></div>
                                                <div class="google_url">
                                                    <span class="default"><?php {{ echo $base->getBaseURLClient(); }} ?></span>
                                                    <span class="url"><?php {{ echo Validation::setValue("policy_seoUrl"); }} ?></span>
                                                </div>
                                                <div class="google_desc"><?php {{ echo Validation::setValue("policy_metaDesc"); }} ?></div>
                                            </div>
                                        </div>
