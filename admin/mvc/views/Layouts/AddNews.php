        ...
        <div class="page_header">
            <div class="container_fluid d_flex justify_content_between align_items_center">
                ...
                <div class="d_flex align_items_center">
                    <button type="submit" name="addNews_action" class="btn_item btn btn_primary">
                    ...
                    <a class="btn_item btn_default" href="News/add">
                                        ...
                                        <div class="form_input">
                                            <label for="news_image">
                                                <input type="hidden" name="news_image" id="news_image" value="<?php {{
                                                    /*----------------------------------------------*/
                                                    echo !empty(Validation::setValue("news_image")) ? Validation::setValue("news_image") : null;
                                                    /*----------------------------------------------*/
                                                }} ?>">
                                                ...
                                                <span class="thumbNail small" style="width: 300px; height: 170px;">
                                                    <img data-src-id="news_image" class="img_cover full_size" src="<?php {{
                                                        /*----------------------------------------------*/
                                                        echo !empty(Validation::setValue("news_image")) ? Validation::setValue("news_image") : "./public/images/logo/no_image-50x50.png";
                                                        /*----------------------------------------------*/
                                                    }} ?>" alt="">
                                                </span>
                                            </label>
                                        ...
                                        <div class="form_input">
                                            <label for="news_bannerPc">
                                                <input type="hidden" id="news_bannerPc" name="news_bannerPc" value="<?php {{
                                                    /*----------------------------------------------*/
                                                    echo !empty(Validation::setValue("news_bannerPc")) ? Validation::setValue("news_bannerPc") : null;
                                                    /*----------------------------------------------*/
                                                }} ?>">
                                                <span class="thumbNail banner __PC">
                                                    <img class="img_cover full_size" src="<?php {{
                                                        /*----------------------------------------------*/
                                                        echo !empty(Validation::setValue("news_bannerPc")) ? Validation::setValue("news_bannerPc") : "./public/images/logo/no_image-50x50.png";
                                                        /*----------------------------------------------*/
                                        ...
                                        <div class="form_input">
                                            <label for="news_bannerMb">
                                                <input type="hidden" id="news_bannerMb" name="news_bannerMb" value="<?php {{
                                                    /*----------------------------------------------*/
                                                    echo !empty(Validation::setValue("news_bannerMb")) ? Validation::setValue("news_bannerMb") : null;
                                                    /*----------------------------------------------*/
                                                }} ?>">
                                                <span class="thumbNail banner __mobile">
                                                    <img class="img_cover full_size" data-src-id="news_bannerMb" src="<?php {{
                                                        /*----------------------------------------------*/
                                                        echo !empty(Validation::setValue("news_bannerMb")) ? Validation::setValue("news_bannerMb") : "./public/images/logo/no_image-50x50.png";
                                                        /*----------------------------------------------*/
                                                    }} ?>" alt="">
                                                </span>
                                            </label>
                                    ...
                                    <div class="form_group d_flex align_items_center">
                                        ...
                                        <div class="form_input">
                                            <select class="form_control" name="news_target" id="news_target">
                                                <option value="blank" <?php {{ echo Validation::setValue("news_target") == "blank" ? "selected" : null; }} ?>>Mở tab mới khi xem video</option>
                                                <option value="self"  <?php {{ echo Validation::setValue("news_target") == "self"  ? "selected" : null; }} ?>>Hiển thị tab hiện tại khi xem video</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="form_group d_flex align_items_center">
                                        ...
                                        <div class="form_input">
                                            <div class="form_list_wrap">
                                                <?php {{ if(!empty($listTotalCateNews)) {
                                                    ...
                                                    <?php
                                                } else { ?> <p class="data_empty_notification text_left">Bạn chưa có danh mục tin tức nào !</p> <?php } }} ?>
                                            </div>
