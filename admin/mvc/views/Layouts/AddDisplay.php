...
<?php
{{ $base = new Base; }} ?>
<main class="main_content" data-layout="addDisplay">
            ...
            <div class="container_fluid d_flex justify_content_between align_items_center">
                <div class="d_flex align_items_end">
                    ...
                    <ol class="breadcrumb d_flex align_items_center">
                        ...
                        <li class="active">
                            <a href="">Thêm bố cục</a>
                        </li>
                    </ol>
                </div>
                <div class="d_flex align_items_center">
                    <button type="submit" name="addDisplay_action" class="btn_item btn btn_primary">
                    ...
                    <a class="btn_item btn_default" href="Display/add">
                                                ...
                                                <div class="grid_column_6">
                                                    <div class="form_list_wrap" style="margin-top: 10px;">
                                                        ...
                                                        <div class="list" style="height: 187px; overflow: auto; margin-top: 10px;">
                                                            <?php {{
                                                                if(!empty(Validation::setValue("cateProd_rela"))) {
                                                                    foreach(Validation::setValue("cateProd_rela") as $cateProd_rela_item) { ?>
                                            ...
                                            <div class="grid_row">
                                                <div class="grid_column_6">
                                                    <div class="form_list_wrap" style="margin-top: 10px;">
                                                        ...
                                                        <div class="list" style="height: 187px; overflow: auto; margin-top: 10px;">
                                                            <?php {{
                                                                if(!empty(Validation::setValue("prod_highlight"))) {
                                                                    foreach(Validation::setValue("prod_highlight") as $prod_highlight_item) { ?>
                                            ...
                                            <div class="grid_row">
                                                <div class="grid_column_6">
                                                    <div class="form_list_wrap" style="margin-top: 10px;">
                                                        ...
                                                        <div class="list" style="height: 187px; overflow: auto; margin-top: 10px;">
                                                            <?php {{
                                                                if(!empty(Validation::setValue("prod_normal"))) {
                                                                    foreach(Validation::setValue("prod_normal") as $prod_normal_item) { ?>
                                            ...
                                            <div class="grid_row">
                                                <div class="grid_column_6">
                                                    <div class="form_list_wrap" style="margin-top: 10px;">
                                                        ...
                                                        <div class="list" style="height: 187px; overflow: auto; margin-top: 10px;">
                                                            <?php {{
                                                                if(!empty(Validation::setValue("prod_mobile"))) {
                                                                    foreach(Validation::setValue("prod_mobile") as $prod_mobile_item) { ?>
