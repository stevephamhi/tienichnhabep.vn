        ...
        <div class="page_header">
            <div class="container_fluid d_flex justify_content_between align_items_center">
                <div class="d_flex align_items_end">
                    <h1>Thêm background</h1>
                    <ol class="breadcrumb d_flex align_items_center">
                        <li>
                            <a href="Home">Trang chủ</a>
                        </li>
                        <li class="active">
                            <a href="">Thêm background</a>
                        </li>
                    </ol>
                </div>
                <div class="d_flex align_items_center">
                    <button type="submit" name="addBackground_action" class="btn_item btn btn_primary">
                                        ...
                                        <div class="form_input">
                                            <label for="background_image">
                                                <input type="hidden" id="background_image" name="background_image" value="<?php {{
                                                    /*--------------------------------------------------------------*/
                                                    echo !empty(Validation::setValue("background_image")) ? Validation::setValue("background_image") : null;
                                                    /*--------------------------------------------------------------*/
                                                }} ?>">
                                                <span class="thumbNail banner __PC" style="height: 1000px;width: 100%;">
                                                    <img class="img_cover full_size" src="<?php {{
                                                        echo !empty(Validation::setValue("background_image")) ? Validation::setValue("background_image") : "./public/images/logo/no_image-50x50.png";
