            ...
            <div class="container_fluid d_flex justify_content_between align_items_center">
                <div class="d_flex align_items_end">
                    ...
                    <ol class="breadcrumb d_flex align_items_center">
                        ...
                        <li class="active">
                            <a href="javascript:;">Cập nhật flash sale</a>
                        </li>
                    </ol>
                </div>
                <div class="d_flex align_items_center">
                    <button type="submit" <?php echo !empty($flashSaleItem) ? "disable" : null; ?> name="updateFlashSale_action" class="btn_item btn btn_primary">
            ...
            <div class="panel_table">
                <div class="panel_heading">
                    <h2 class="panel_title">
                        ...
                        <span>Cập nhật flash sale</span>
                    </h2>
                </div>
                <?php if(!empty($flashSaleItem)) : ?>
                            ...
                            <div class="tab_content">
                                <div class="tab_pane" id="tab_general">
                                        ...
                                        <div class="switch_status">
                                            <label for="status_value" class="status_toogle on">
                                                <input type="checkbox" name="prod_flashsale_status" <?php {{
                                                    /*----------------------------------------------------*/
                                                    if(!empty(Validation::setValue("prod_flashsale_status")))
                                                    { echo Validation::setValue("prod_flashsale_status") == "on" ? "checked" : null; }
                                                    else
                                                    { echo $flashSaleItem['prod_flashsale_status'] == "on" ? "checked" : null; }
                                                    /*----------------------------------------------------*/
                                    ...
                                    <div class="content_group">
                                                    ...
                                                    <?php {{
                                                        if(!empty($list_customerGroup)) {
                                                            foreach($list_customerGroup as $customerGroupItem) { ?>
                                                                <option <?php {{
                                                                    /*----------------------------------------------------*/
                                                                    if(!empty(Validation::setValue("prod_flashsale_customer_groupId")))
                                                                    { echo Validation::setValue("prod_flashsale_customer_groupId") == $customerGroupItem['customerGroup_id'] ? "selected" : null; }
                                                                    else
                                                                    { if(!empty($flashSaleItem['prod_flashsale_customer_groupId']))
                                                                    { echo $flashSaleItem['prod_flashsale_customer_groupId'] == $customerGroupItem['customerGroup_id'] ? "selected" : null; } }
                                                                    /*----------------------------------------------------*/
                                                                }} ?> value="<?php {{
                                                                    /*----------------------------------------------------*/
                                        ...
                                        <div class="form_group d_flex align_items_center">
                                            ...
                                            <div class="form_input">
                                                <input class="form_control" type="number" value="<?php {{
                                                    /*----------------------------------------------------*/
                                                    if(!empty(Validation::setValue("prod_flashsale_order")))
                                                    { echo Validation::setValue("prod_flashsale_order"); }
                                                    else
                                                    { echo !empty($flashSaleItem['prod_flashsale_order']) ? $flashSaleItem['prod_flashsale_order'] : null; }
                                                    /*----------------------------------------------------*/
                                        ...
                                        <div class="form_group d_flex align_items_center">
                                            ...
                                            <div class="form_input">
                                                <input class="form_control" type="text" value="<?php {{
                                                    /*----------------------------------------------------*/
                                                    if(!empty(Validation::setValue("prod_flashsale_price")))
                                                    { echo Validation::setValue("prod_flashsale_price"); }
                                                    else
                                                    { echo !empty($flashSaleItem["prod_flashsale_price"]) ? $flashSaleItem["prod_flashsale_price"] : null; }
                                                    /*----------------------------------------------------*/
                                        ...
                                        <div class="form_group d_flex align_items_center">
                                            <label for="prod_flashsale_dateStart" class="form_label"><strong style="color: #f00;">*</strong> Date Start</label>
                                            <div class="form_input">
                                                <input class="form_control" type="date" value="<?php {{
                                                    /*----------------------------------------------------*/
                                                    if(!empty(Validation::setValue("prod_flashsale_dateStart")))
                                                    { echo Validation::setValue("prod_flashsale_dateStart"); }
                                                    else
                                                    { echo !empty($flashSaleItem['prod_flashsale_dateStart']) ? Format::formatTimeDateInput($flashSaleItem['prod_flashsale_dateStart']) : null; }
                                                    /*----------------------------------------------------*/
                                        ...
                                        <div class="form_group d_flex align_items_center">
                                            <label for="prod_flashsale_dateEnd" class="form_label"><strong style="color: #f00;">*</strong> Date End</label>
                                            <div class="form_input">
                                                <input class="form_control" type="date" value="<?php {{
                                                    /*----------------------------------------------------*/
                                                    if(!empty(Validation::setValue("prod_flashsale_dateEnd")))
                                                    { echo Validation::setValue("prod_flashsale_dateEnd"); }
                                                    else
                                                    { echo !empty($flashSaleItem['prod_flashsale_dateEnd']) ? Format::formatTimeDateInput($flashSaleItem['prod_flashsale_dateEnd']) : null; }
                                                    /*----------------------------------------------------*/
                                                                    ...
                                                                    <label for="prod_<?php {{ echo $prodItem['prod_id']; }} ?>" class="item d_flex align_items_center">
                                                                        <input type="checkbox" name="prodId[]" class="prodId_checkItem" <?php {{
                                                                            ...
                                                                            if(!empty(Validation::setValue("prodId"))) {
                                                                                ...
                                                                                {
                                                                                    echo $flashSaleItem['prod_flashsale_prodId'] == $prodItem['prod_id'] ? "checked" : null;
                                                                                }
                                                                                else { echo null; }
                                                                            }
                                                                            /*----------------------------------------------*/
