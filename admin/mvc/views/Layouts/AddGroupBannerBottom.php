            ...
            <div class="container_fluid d_flex justify_content_between align_items_center">
                <div class="d_flex align_items_end">
                    ...
                    <ol class="breadcrumb d_flex align_items_center">
                        ...
                        <li class="active">
                            <a href="javascript:;">Thêm nhóm banner dưới</a>
                        </li>
                    </ol>
                </div>
                <div class="d_flex align_items_center">
                    ...
                    <a class="btn_item btn_default" href="GroupbannerBottom/add">
            ...
            <div class="panel_table">
                <div class="panel_heading">
                    <h2 class="panel_title">
                        ...
                        <span>Thêm nhóm banner dưới</span>
                    </h2>
                </div>
                                    ...
                                    <table class="table mini_banner_banner_table">
                                        ...
                                        <tbody>
                                            <?php {{ if(!empty(Validation::setValue("listBannerBottom"))) {
                                                $orderRow = 0;
                                                foreach(Validation::setValue("listBannerBottom") as $bannerBottomItem) {
                                                ?>
                                                <tr id="bannerBottomImgRow<?php {{ echo $orderRow; }} ?>">
                                                    <td>
                                                        <div class="form_group d_flex align_items_center">
                                                            ...
                                                            <div class="form_input grid_column_9">
                                                                <input class="form_control" type="text" value="<?php {{ echo !empty($bannerBottomItem['title']) ? $bannerBottomItem['title'] : null; }} ?>" name="bannerBottom[<?php {{ echo $orderRow; }} ?>][title]" placeholder="Tiêu đề" autocomplete="off" spellcheck="false">
                                                            </div>
                                                        </div>
                                                        <div class="form_group d_flex align_items_center">
                                                            <label for="" class="form_label grid_column_2">Mô tả</label>
                                                            <div class="form_input grid_column_9">
                                                                <input class="form_control" type="text" value="<?php {{ echo !empty($bannerBottomItem['desc']) ? $bannerBottomItem['desc'] : null; }} ?>" name="bannerBottom[<?php {{ echo $orderRow; }} ?>][desc]" placeholder="Mô tả" autocomplete="off" spellcheck="false">
                                                            </div>
                                                        </div>
                                                        <div class="form_group d_flex align_items_center">
                                                            <label for="" class="form_label grid_column_2">Đường dẫn</label>
                                                            <div class="form_input grid_column_9">
                                                                <input class="form_control" type="text" value="<?php {{ echo !empty($bannerBottomItem['link']) ? $bannerBottomItem['link'] : null; }} ?>" name="bannerBottom[<?php {{ echo $orderRow; }} ?>][link]" placeholder="Đường dẫn" autocomplete="off" spellcheck="false">
                                                            </div>
                                                        </div>
                                                        <div class="form_group d_flex align_items_center" style="border-bottom: 1px solid #E5E5E5;">
                                                            ...
                                                            <div class="form_input grid_column_9">
                                                                <select class="form_control" name="bannerBottom[<?php {{ echo $orderRow; }} ?>][target]" id="">
                                                                    <option value="blank" <?php {{ echo $bannerBottomItem['target'] == "blank" ? "selected" : null; }} ?>>Hiển thị tab mới</option>
                                                                    <option value="self"  <?php {{ echo $bannerBottomItem['target'] == "self"  ? "selected" : null; }} ?>>Hiển thị tab hiện tại</option>
                                                                </select>
                                                            </div>
                                                        </div>
                                                    </td>
                                                    <td class="position_relative">
                                                        ...
                                                        <div class="thumbNail d_flex justify_content_center align_items_center" style="width: 300px; height: 200px; display: flex;">
                                                            <img data-src-id="bannerBottomPC<?php {{ echo $orderRow; }} ?>" class="full_size img_cover" src="<?php {{
                                                                /*---------------------------------------------------------------------*/
                                                                echo !empty($bannerBottomItem['bannerPC']) ? $bannerBottomItem['bannerPC'] : "./public/images/logo/no_image-50x50.png";
                                                                /*---------------------------------------------------------------------*/
                                                            }} ?>" alt="">
                                                        </div>
                                                        <input type="hidden" name="bannerBottom[<?php {{ echo $orderRow; }} ?>][bannerPC]" value="<?php {{
                                                            /*-------------------------------------------------------------------------*/
                                                            echo !empty($bannerBottomItem['bannerPC']) ? $bannerBottomItem['bannerPC'] : null;
                                                            /*-------------------------------------------------------------------------*/
                                                    ...
                                                    <td>
                                                        <input class="form_control" type="number" name="bannerBottom[<?php {{ echo $orderRow; }} ?>][order]" value="<?php {{
                                                            /*--------------------------------------------------------------------*/
                                                            echo !empty($bannerBottomItem['order']) ? $bannerBottomItem['order'] : null;
                                                            /*--------------------------------------------------------------------*/
