        ...
        <div class="page_header">
            <div class="container_fluid d_flex justify_content_between align_items_center">
                <div class="d_flex align_items_end">
                    <h1>Nhóm banner bottom</h1>
                    <ol class="breadcrumb d_flex align_items_center">
                        <li>
                            <a href="Home">Trang chủ</a>
                        </li>
                        <li class="active">
                            <a href="javascript:;">Cập nhật nhóm banner bottom</a>
                        </li>
                    </ol>
                </div>
                <div class="d_flex align_items_center">
                    ...
                    <a class="btn_item btn_default" href="GroupbannerBottom">
            ...
            <div class="panel_table">
                <div class="panel_heading">
                    <h2 class="panel_title">
                        ...
                        <span>Cập nhật nhóm banner bottom</span>
                    </h2>
                </div>
                            ...
                            <div class="tab_content">
                                ...
                                <div class="tab_pane" id="tab_mini_banner">
                                    <table class="table mini_banner_banner_table">
                                        ...
                                        <tbody>
                                            <?php {{ if(!empty(Validation::setValue("listBannerBottom"))) {
                                                $orderRow = 0;
                                                foreach(Validation::setValue("listBannerBottom") as $bannerItem) {
                                                ?>
                                                <tr id="bannerBottomImgRow<?php {{ echo $orderRow; }} ?>">
                                                    <td>
                                                        <div class="form_group d_flex align_items_center">
                                                            <label for="title" class="form_label grid_column_2">Tiêu đề</label>
                                                            <div class="form_input grid_column_9">
                                                                <input class="form_control" type="text" value="<?php {{ echo !empty($bannerItem['title']) ? $bannerItem['title'] : null; }} ?>" name="bannerBottom[<?php {{ echo $orderRow; }} ?>][title]" placeholder="Tiêu đề" autocomplete="off" spellcheck="false">
                                                            </div>
                                                        </div>
                                                        <div class="form_group d_flex align_items_center">
                                                            <label for="" class="form_label grid_column_2">Mô tả</label>
                                                            <div class="form_input grid_column_9">
                                                                <input class="form_control" type="text" value="<?php {{ echo !empty($bannerItem['desc']) ? $bannerItem['desc'] : null; }} ?>" name="bannerBottom[<?php {{ echo $orderRow; }} ?>][desc]" placeholder="Mô tả" autocomplete="off" spellcheck="false">
                                                            </div>
                                                        </div>
                                                        <div class="form_group d_flex align_items_center">
                                                            <label for="" class="form_label grid_column_2">Đường dẫn</label>
                                                            <div class="form_input grid_column_9">
                                                                <input class="form_control" type="text" value="<?php {{ echo !empty($bannerItem['link']) ? $bannerItem['link'] : null; }} ?>" name="bannerBottom[<?php {{ echo $orderRow; }} ?>][link]" placeholder="Đường dẫn" autocomplete="off" spellcheck="false">
                                                            </div>
                                                        </div>
                                                        <div class="form_group d_flex align_items_center" style="border-bottom: 1px solid #E5E5E5;">
                                                            ...
                                                            <div class="form_input grid_column_9">
                                                                <select class="form_control" name="bannerBottom[<?php {{ echo $orderRow; }} ?>][target]" id="">
                                                    ...
                                                    <td class="position_relative">
                                                        ...
                                                        <div class="thumbNail d_flex justify_content_center align_items_center" style="width: 300px; height: 200px; display: flex;">
                                                            <img data-src-id="bannerBottomPC<?php {{ echo $orderRow; }} ?>" class="full_size img_cover" src="<?php {{
                                                                /*---------------------------------------------------------------------*/
                                                                echo !empty($bannerItem['bannerPC']) ? $bannerItem['bannerPC'] : "./public/images/logo/no_image-50x50.png";
                                                                /*---------------------------------------------------------------------*/
                                                            }} ?>" alt="">
                                                        </div>
                                                        <input type="hidden" name="bannerBottom[<?php {{ echo $orderRow; }} ?>][bannerPC]" value="<?php {{
                                                            /*-------------------------------------------------------------------------*/
                                                            echo !empty($bannerItem['bannerPC']) ? $bannerItem['bannerPC'] : null;
                                                            /*-------------------------------------------------------------------------*/
                                                        }} ?>" id="bannerBottomPC<?php {{ echo $orderRow; }} ?>">
                                                        <div class="popover position_absolute" style="top: 84%;left: 41%;transform: translate(0);">
                                                            <div class="popover_content d_flex align_items_center">
                                                                <a style="padding: 6px 10px 7px 12px;margin-right: 3px;" href="./public/plugins/filemanager/dialog.php?type=1&field_id=bannerBottomPC<?php {{ echo $orderRow; }} ?>" type="button" data-id-input-image="bannerBottomPC<?php {{ echo $orderRow; }} ?>" class="button_image btn btn_primary iframe-btn" title="Thêm banner chính">
                                                                    <i class="fa fa-pencil"></i>
                                                                </a>
                                                                <button type="button" style="padding: 7px 12px;" data-id-clear-img="bannerBottomPC<?php {{ echo $orderRow; }} ?>" class="button_clear btn btn_danger" title="Xóa ảnh này">
                                                    ...
                                                    <td>
                                                        <input class="form_control" type="number" name="bannerBottom[<?php {{ echo $orderRow; }} ?>][order]" value="<?php {{
                                                            /*--------------------------------------------------------------------*/
                                                        ...
                                                        <tr id="bannerBottomImgRow<?php {{ echo $orderRow; }} ?>">
                                                            <td>
                                                                <div class="form_group d_flex align_items_center">
                                                                    <label for="title" class="form_label grid_column_2">Tiêu đề</label>
                                                                    <div class="form_input grid_column_9">
                                                                        <input class="form_control" type="text" value="<?php {{ echo !empty($bannerItem['banner_name']) ? $bannerItem['banner_name'] : null; }} ?>" name="bannerBottom[<?php {{ echo $orderRow; }} ?>][title]" placeholder="Tiêu đề" autocomplete="off" spellcheck="false">
                                                                    </div>
                                                                </div>
                                                                <div class="form_group d_flex align_items_center">
                                                                    <label for="" class="form_label grid_column_2">Mô tả</label>
                                                                    <div class="form_input grid_column_9">
                                                                        <input class="form_control" type="text" value="<?php {{ echo !empty($bannerItem['banner_desc']) ? $bannerItem['banner_desc'] : null; }} ?>" name="bannerBottom[<?php {{ echo $orderRow; }} ?>][desc]" placeholder="Mô tả" autocomplete="off" spellcheck="false">
                                                                    </div>
                                                                </div>
                                                                <div class="form_group d_flex align_items_center">
                                                                    <label for="" class="form_label grid_column_2">Đường dẫn</label>
                                                                    <div class="form_input grid_column_9">
                                                                        <input class="form_control" type="text" value="<?php {{ echo !empty($bannerItem['banner_link']) ? $bannerItem['banner_link'] : null; }} ?>" name="bannerBottom[<?php {{ echo $orderRow; }} ?>][link]" placeholder="Đường dẫn" autocomplete="off" spellcheck="false">
                                                                    </div>
                                                                </div>
                                                                <div class="form_group d_flex align_items_center" style="border-bottom: 1px solid #E5E5E5;">
                                                                    <label for="" class="form_label grid_column_2"></label>
                                        ...
                                        <?php {{ echo Validation::formError("listBannerBottom"); }} ?>
                                    </table>
                                </div>
                            </div>
                        </div>
...
{
    return `<tr id="bannerBottomImgRow${order}">
                <td>
                    <div class="form_group d_flex align_items_center">
                        <label for="" class="form_label grid_column_2">Tiêu đề</label>
                        <div class="form_input grid_column_9">
                            <input class="form_control" type="text" name="bannerBottom[${order}][title]" placeholder="Tiêu đề" autocomplete="off" spellcheck="false">
                        </div>
                    </div>
                    <div class="form_group d_flex align_items_center">
                        <label for="" class="form_label grid_column_2">Mô tả</label>
                        <div class="form_input grid_column_9">
                            <input class="form_control" type="text" name="bannerBottom[${order}][desc]" placeholder="Mô tả" autocomplete="off" spellcheck="false">
                        </div>
                    </div>
                    <div class="form_group d_flex align_items_center">
                        <label for="" class="form_label grid_column_2">Đường dẫn</label>
                        <div class="form_input grid_column_9">
                            <input class="form_control" type="text" name="bannerBottom[${order}][link]" placeholder="Đường dẫn" autocomplete="off" spellcheck="false">
                        </div>
                    </div>
                    <div class="form_group d_flex align_items_center" style="border-bottom: 1px solid #E5E5E5;">
                        <label for="" class="form_label grid_column_2"></label>
                        <div class="form_input grid_column_9">
                            <select class="form_control" name="bannerBottom[${order}][target]" id="">
                ...
                <td class="position_relative">
                    <span>300x150</span>
                    <div class="thumbNail d_flex justify_content_center align_items_center" style="width: 300px; height: 200px; display: flex;">
                        <img data-src-id="bannerBottomPC${order}" class="full_size img_cover" src="./public/images/logo/no_image-50x50.png" alt="">
                    </div>
                    <input type="hidden" name="bannerBottom[${order}][bannerPC]" id="bannerBottomPC${order}">
                    <div class="popover position_absolute" style="top: 84%;left: 41%;transform: translate(0);">
                        <div class="popover_content d_flex align_items_center">
                            <a style="padding: 6px 10px 7px 12px;margin-right: 3px;" href="./public/plugins/filemanager/dialog.php?type=1&field_id=bannerBottomPC${order}" type="button" data-id-input-image="bannerBottomPC${order}" class="button_image btn btn_primary iframe-btn" title="Thêm banner chính">
                                <i class="fa fa-pencil"></i>
                            </a>
                            <button type="button" style="padding: 7px 12px;" data-id-clear-img="bannerBottomPC${order}" class="button_clear btn btn_danger" title="Xóa ảnh này">
                                <i class="fa fa-trash-o"></i>
                            </button>
                        </div>
                    </div>
                ...
                <td>
                    <input class="form_control" type="number" name="bannerBottom[${order}][order]" value="${order+1}" placeholder="Sắp xếp" autocomplete="off" spellcheck="false">
                </td>
                <td>
                    <button type="button" class="btn btn_danger btnClear">
                        <i class="fa fa-minus-circle"></i>
