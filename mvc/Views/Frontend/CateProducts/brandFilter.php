<div class="filter_brands sidebar_box_wrap">
    ...
    <div class="sidebar_item_box_body">
        <div class="filter_body">
            <ul class="list_filter">
                ...
                <li class="filter_item">
                    <label for="chk_brand_<?php {{ echo $brandItem['id']; }} ?>" class="chk_filter_item d_flex align_items_center position_relative">
                        <a href="<?php {{ echo Config::getBaseUrlClient("{$cateProdUrl}/brand=" . Format::create_slug($brandItem['name']) . "-{$brandItem['id']}{$priceUrl}{$sortUrl}"); }} ?>" title="<?php {{ echo $brandItem['name']; }} ?>" class="filter_link">
            ...
            <a href="<?php {{ echo Config::getBaseUrlClient( "{$cateProdUrl}{$priceUrl}{$sortUrl}" ); }} ?>" class="clearFilter">Làm mới</a>
        </div>
    </div>
</div>